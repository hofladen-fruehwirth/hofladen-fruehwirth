 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ee="FirebaseError";class b extends Error{constructor(e,r,n){super(r),this.code=e,this.customData=n,this.name=Ee,Object.setPrototypeOf(this,b.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Z.prototype.create)}}class Z{constructor(e,r,n){this.service=e,this.serviceName=r,this.errors=n}create(e,...r){const n=r[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?_e(i,n):"Error",h=`${this.serviceName}: ${o} (${s}).`;return new b(s,h,n)}}function _e(t,e){return t.replace(ve,(r,n)=>{const s=e[n];return s!=null?String(s):`<${n}?>`})}const ve=/\{\$([^}]+)}/g;function zt(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function T(t,e){if(t===e)return!0;const r=Object.keys(t),n=Object.keys(e);for(const s of r){if(!n.includes(s))return!1;const i=t[s],o=e[s];if(F(i)&&F(o)){if(!T(i,o))return!1}else if(i!==o)return!1}for(const s of n)if(!r.includes(s))return!1;return!0}function F(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zt=yt;function wt(t,e={}){let r=t;typeof e!="object"&&(e={name:e});const n={name:$,automaticDataCollectionEnabled:!0,...e},s=n.name;if(typeof s!="string"||!s)throw u.create("bad-app-name",{appName:String(s)});if(r||(r=X()),!r)throw u.create("no-options");const i=I.get(s);if(i){if(T(r,i.options)&&T(n,i.config))return i;throw u.create("duplicate-app",{appName:s})}const o=new Ae(s);for(const c of P.values())o.addComponent(c);const h=new It(r,n,o);return I.set(s,h),h}function er(t=$){const e=I.get(t);if(!e&&t===$&&X())return wt();if(!e)throw u.create("no-app",{appName:t});return e}function B(t,e,r){let n=Et[t]??t;r&&(n+=`-${r}`);const s=n.match(/\s|\//),i=e.match(/\s|\//);if(s||i){const o=[`Unable to register library "${n}" with version "${e}":`];s&&o.push(`library name "${n}" contains illegal characters (whitespace or "/")`),s&&i&&o.push("and"),i&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),d.warn(o.join(" "));return}x(new v(`${n}-version`,()=>({library:n,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dt="firebase-heartbeat-database",St=1,g="firebase-heartbeat-store";let O=null;function re(){return O||(O=Ue(Dt,St,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(g)}catch(r){console.warn(r)}}}}).catch(t=>{throw u.create("idb-open",{originalErrorMessage:t.message})})),O}async function Ct(t){try{const r=(await re()).transaction(g),n=await r.objectStore(g).get(ne(t));return await r.done,n}catch(e){if(e instanceof b)d.warn(e.message);else{const r=u.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});d.warn(r.message)}}}async function G(t,e){try{const n=(await re()).transaction(g,"readwrite");await n.objectStore(g).put(e,ne(t)),await n.done}catch(r){if(r instanceof b)d.warn(r.message);else{const n=u.create("idb-set",{originalErrorMessage:r==null?void 0:r.message});d.warn(n.message)}}}function ne(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rt(t){x(new v("platform-logger",e=>new Ve(e),"PRIVATE")),x(new v("heartbeat",e=>new Ot(e),"PRIVATE")),B(R,V,t),B(R,V,"esm2020"),B("fire-js","")}Rt("");export{B as A,v as C,Z as E,b as F,a as L,Zt as S,Xt as _,Ne as a,Qt as b,x as c,he as d,xt as e,Jt as f,T as g,Gt as h,er as i,pe as j,$t as k,Pt as l,Kt as m,Q as n,wt as o,kt as p,Yt as q,Lt as r,zt as s,Ut as t,Ht as u,Ft as v,jt as w,qt as x,Vt as y,Wt as z};
